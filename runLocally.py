...
fid_sim_out = open('logs/sim_out.log', 'a', buffering=0)
a.append(fid_sim_out)
fid_sim_err = open('logs/sim_err.log', 'a', buffering=0)
a.append(fid_sim_err)
fid_train_out = open('logs/train_out.log', 'a', buffering=0)
a.append(fid_train_out)
fid_train_err = open('logs/train_err.log', 'a', buffering=0)
a.append(fid_train_err)
fid_rviz_out = open('logs/rviz_out.log', 'a', buffering=0)
a.append(fid_rviz_out)
fid_rviz_err = open('logs/rviz_err.log', 'a', buffering=0)
